...
def cmd_build_clips(a):
    ...
    build_clip_arrays({1: a.fight, 0: a.nonfight}, a.all_dir, a.roi, a.workers,
                      enhance_frames=not getattr(a, "no_enhance", False))
...
def main(argv: list[str] | None = None) -> None:
    ...
    s.add_argument("--roi", default="cluster",
                   choices=["cluster", "union", "none", "adaptive"])
    s.add_argument("--workers", type=int, default=16)
    s.add_argument("--no-enhance", action="store_true")
