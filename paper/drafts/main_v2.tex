...
$p=0.006$), and no measurable gain on RWF-2000 once the training recipe is
tuned ($-0.04$ points, $p=0.78$, three seeds), where the recipe itself is
worth 1.6 to 1.9 points. Six Kinetics backbones trained under the same
...
\begin{table}[t]
  ...
  \end{tabular}
\end{table}
% TODO: RLVS table, same rows, once the runs finish.
