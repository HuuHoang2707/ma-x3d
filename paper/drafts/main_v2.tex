...
of the violent class, and ROC-AUC. Differences between two models are tested
with the exact McNemar test on their paired OOF predictions and reported
with 95\% bootstrap intervals over clips. Cost is measured as parameters after
